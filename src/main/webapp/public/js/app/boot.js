(function(global){
    ...
    var loadScriptSync = function() {
        ...
        url = appRootOffsetPath + "js/" + url.split('.').join('/');
        var xhr = createNewTransport();
        var method = "GET";
        xhr.open(method, url + ".js", false);
    ...
    var stylesheetHome = appRootOffsetPath + "css/";
